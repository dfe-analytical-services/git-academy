...
-   Type **git log** and press enter to view recent commits. Press **q** when you are ready to exit git log. Type **git status** and press enter to check the state of the cloned repository (at this point, it should say everything is up to date, as you haven't made any changes yet).
