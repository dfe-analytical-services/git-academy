...
Git BASH is a terminal prompt that you can use to run Git commands. It comes 
with Git, so you'll have it as soon as you've installed Git. It gives you access 
to all Git commands as well as other system commands (such as creating files,
navigating through your folders, making directories, removing files and many, 
many other things).
...
Most modern IDEs (e.g. Visual Studio, R-Studio, PyCharm) provide some level of 
