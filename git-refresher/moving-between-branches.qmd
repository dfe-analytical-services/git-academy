...
Assuming you've not skipped any steps, you should now have at least 3 branches that you've had active during this tutorial: `main`, `<github_username>/main` and `<github_username>/development`.
