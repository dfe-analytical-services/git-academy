...
In this section we will be exploring different aspects of a GitHub repository, including viewing branches, code and history. We will edit the logbook and make a commit to record these tasks.
...
3. Navigate to the branch you previously created i.e. `<github_id>_main`. You can do this by clicking on the branches button again as in [viewing different branches](#viewing-different-branches) and selecting your branch, or using the branch drop-down as below to click on your branch: 
...
2.  Select the branch you would like to see history for from the 'Branch' drop down menu, in this case, the `<github_id>_main` branch you created. 
...
6. You can also use the Blame tab to view the history of each file, as in [viewing history](#viewing-history). 
