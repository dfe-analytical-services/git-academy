...
7. You will need to switch to the code tab to view and edit the raw contents of the file. The preview tab will show you a preview for supported files like Markdown and Quarto and the blame tab shows line by line revision history, tracking who made each change and when.
