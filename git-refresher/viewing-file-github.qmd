...
3. Find and select the branch you previously created i.e. `<github_id>/main`. You can do this by clicking on the branches button again as in [viewing different branches](#viewing-different-branches) and selecting your branch, or using the branch drop-down as below to click on your branch: 
