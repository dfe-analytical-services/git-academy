...
Open up the Git panel in PyCharm and you should see something like the screenshot below. Right click on **main** and select **New branch from '\<github_id\>/main'...**.
...
Now you have made your development branch, go to your git log and update tick the 'making a development branch' box. Use the [recording changes](recording-changes) section for a reminder on how to make and save changes.
